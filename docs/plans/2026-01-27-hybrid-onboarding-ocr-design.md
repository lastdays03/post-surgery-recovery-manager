...
## 부록: 정밀 프로파일링 의학 지표 기준

| 구분 | 데이터 필드 | 기준 및 의학적 의미 |
| :--- | :--- | :--- |
| **영양 위험도** | NRS-2002 점수 | ≥3점 위험, ≥5점 고위험 |
| | 체중 변화 | 6개월 내 10~15% 감소 시 중증 위험 |
| | BMI | 18.5 미만 시 고위험 |
| | SGA 등급 | C등급일 경우 중증 영양 불량 |
| | 혈청 알부민 | 30 g/L 미만 시 고위험 (단백질 결핍) |
| **섭취 능력** | 예상 금식 기간 | >5일, >7일, >14일 (영양 공급 경로 결정) |
| | 섭취율 | 필요량의 50% 미만 섭취 시 추가 보충 필요 |
| **근육** | 근감소증 | 합병증 위험 증가 및 재활 강도 조정 |
