      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="text-gray-600 mt-1">오늘도 건강한 회복을 응원해요</p>
          </div>
          <div className="flex gap-2 w-full sm:w-auto">
            {!hasAdvancedMetrics && (
              <Button
                variant="outline"
                onClick={() =>
                  router.push("/onboarding/document/advanced?from=dashboard")
                }
                className="flex-1 sm:flex-none bg-white hover:bg-gray-50 border-gray-300 text-md text-gray-500 p-4 border-1"
              >
                자세한 의료 정보 입력
              </Button>
            )}
            ...
            >
              <CarouselContent className="-ml-4">
                {adviceList.map((advice, index) => (
                  ...
                  >
                    <Card
                      className={`p-5 border-l-4 shadow-sm rounded-xl h-full ${
                        advice.type === "warning"
